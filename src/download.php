...
$res = mysqli_query($con, "select studentid, name, gender, college, major, class, phone, qq, wechat, song from singer into outfile '".dirname(__FILE__)."/csv/singer.csv' character set gbk fields terminated by ',' enclosed by '\"' lines terminated by '\r\n'");
